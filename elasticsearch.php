...
class Wp_ElasticSearch
{
    ...
    function on_show_page()
    {
        ...
        <div id="wp-searchbox-io" class="wrap">
            ...
            <p>WP ElasticSearch is a WordPress plugin that lets you index your entire website components by using <img
                    src='<?php echo $this->plugin_url . "images/elasticsearch.ico"?>'/><a
                    href="http://www.elasticsearch.org/" target="_blank">ElasticSearch</a>.</p>
            ...
            <p>This plugin developed by <img src='<?php echo $this->plugin_url . "images/searchbox_io.png"?>'/> <a
                    href="http://www.searchbox.io/" target="_blank">SearchBox.io</a> cloud hosted ElasticSearch as
                service.</p>
        </div>
